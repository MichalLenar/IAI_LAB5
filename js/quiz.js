...
let element2 = document.querySelector('#MAXindex');
let points = 0;

window.onload=function(){setQuestion(0);}
...
if (index >= 0 && index <= preQuestions.length) {
...
let obj2 = JSON.parse(localStorage.getItem("klucz"));
